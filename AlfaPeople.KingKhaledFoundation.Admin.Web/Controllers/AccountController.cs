...
namespace AlfaPeople.KingKhaledFoundation.Admin.Web.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public ActionResult Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    var res = repository.FindOne<AspNetUser>(f => f.Id == userLogin.Id);
                    if (res.AspNetRoles.Select(d => d.Name).First() == "Admin" ||
                        res.AspNetRoles.Select(d => d.Name).First() == "CB Manager" ||
                        res.AspNetRoles.Select(d => d.Name).First() == "CB Supervisor" ||
                        res.AspNetRoles.Select(d => d.Name).First() == "CB Analyst")
                    {
        ...
        {
            ViewBag.Name = new SelectList(repository.Find<AspNetRole>(f => f.Name != "Corporation" && f.Name != "Corporation IndIvidual" && f.Name != "IndIvidual"), "Name", "Name");
