    ...
    public class ManageController : BaseController
    {
        ...
        public ActionResult ChangePassword(ChangePasswordViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                Guid BackendUserId = Guid.Parse(user.Id);
                var BackendUser = repository.GetByKey<BackendUser>(BackendUserId);
                BackendUser.Password = model.NewPassword;
                repository.Update<BackendUser>(BackendUser);
