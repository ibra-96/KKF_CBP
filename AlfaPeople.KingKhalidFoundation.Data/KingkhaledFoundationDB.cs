...
namespace AlfaPeople.KingKhalidFoundation.Data
{
    public partial class KingkhaledFoundationDB : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<IncubationWorkshopBLTransactions>()
     .HasRequired(t => t.IncubationWorkshop)        
     .WithMany(w => w.IncubationWorkshopBLTransactions)  
     .HasForeignKey(t => t.IncubationWorkshopID)          
     .WillCascadeOnDelete(true);                
            //3-2-2026shadia
            modelBuilder.Entity<ProjectImpactEvaluation>()
    .HasMany(e => e.ProjectImpactEvaluationRequests)
    .WithRequired(r => r.ProjectImpactEvaluation)
    .HasForeignKey(r => r.ProjectImpactEvaluationId)
    .WillCascadeOnDelete(false);

            modelBuilder.Entity<FrontendUser>()
                .HasMany(u => u.ProjectImpactEvaluationRequests)
                .WithRequired(r => r.FrontendUser)
                .HasForeignKey(r => r.FrontendUserId)
                .WillCascadeOnDelete(false);

            modelBuilder.Entity<IncubationWorkshop>()
                .HasMany(w => w.ProjectImpactEvaluations)
                .WithRequired(e => e.IncubationWorkshop)
                .HasForeignKey(e => e.IncubationWorkshopID)
                .WillCascadeOnDelete(false);
        ...
        //
        //3-2-2026shadia
        public virtual DbSet<ProjectImpactEvaluation> ProjectImpactEvaluations { get; set; }
        public virtual DbSet<ProjectImpactEvaluationRequest> ProjectImpactEvaluationRequests { get; set; }
        //
